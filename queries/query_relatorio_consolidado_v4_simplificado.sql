-- ================================================================================
-- QUERY V4 - RELATORIO CONSOLIDADO POR PRODUTO (SIMPLIFICADO)
-- ================================================================================
...
SELECT * FROM (
    SELECT
        ...
        CASE
            WHEN NVL(WMS.SALDO_WMS_TELA, 0) > NVL(PED.QTD_PEDIDO_PENDENTE, 0)
            THEN NVL(WMS.SALDO_WMS_TELA, 0) - NVL(PED.QTD_PEDIDO_PENDENTE, 0)
            ELSE 0
        END AS WMS_APOS_PEDIDOS,
